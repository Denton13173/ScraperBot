...
def migrate_data(deals):
    """
    Migrate deal data to a SQLite database.

    Parameters:
    deals (list): A list of dictionaries containing 'sku' and 'discount' keys.
...
if __name__ == "__main__":
    # Sample deals for testing the migration function
